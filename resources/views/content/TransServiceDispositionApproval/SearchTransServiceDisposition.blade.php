...
<div class="card border border-dark">
    <div class="card-header bg-dark clearfix">
        ...
        <div class="form-actions float-right">
            <button onclick="location.href='{{ url('trans-service-disposition-approval') }}'" name="Find" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="20%" style='text-align:center'>Nama Bagian</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$TransServiceDispositionApproval->getSectionName($disposition['section_id'])}}</td>
                        <td style='text-align:center'>
                            <a type="button" class="btn btn-outline-primary btn-sm" href="{{ url('/trans-service-disposition-approval/add/'.$disposition['service_disposition_id']) }}"><i class="fa fa-plus"></i></a>
                            <a type="button" class="btn btn-outline-warning btn-sm" href="{{ url('/trans-service-disposition-approval/edit/'.$disposition['service_disposition_id']) }}"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                    @endforeach
