                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='text-align:center'>
                            <a type="button" class="btn btn-outline-primary btn-sm" href="{{ url('/trans-service-disposition-review/add/'.$disposition['service_disposition_id']) }}"><i class="fa fa-plus"></i></a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                    @endforeach
