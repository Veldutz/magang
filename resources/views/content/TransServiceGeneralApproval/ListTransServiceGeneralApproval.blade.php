...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Daftar Persetujuan Surat Umum</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Daftar Persetujuan Surat Umum</b> <small>Mengelola Persetujuan Surat Umum</small>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="{{route('filter-service-general-approval')}}" enctype="multipart/form-data">
    @csrf
...
<div class="card border border-dark">
    <div class="card-header bg-dark clearfix">
        ...
        <div class="form-actions float-right">
            <button onclick="location.href='{{ url('trans-service-general-approval/search') }}'" name="Find" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Persetujuan Surat Umum Baru</button>
        </div>
    </div>
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="15%" style='text-align:center'>Nomor Pengajuan Surat Umum</th>
                        <th width="15%" style='text-align:center'>Tanggal Pengajuan</th>
                        <th width="20%" style='text-align:center'>Nama Instansi</th>
                        <th width="10%" style='text-align:center'>Nomor WA</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <?php if($service['service_general_status']==0){?>
                            <a type="button" class="btn btn-outline-info btn-sm" href="{{ url('/trans-service-general-approval/detail/'.$service['service_general_id']) }}">Detail</a>
                            <a type="button" class="btn btn-outline-danger btn-sm" href="{{ url('/trans-service-general-approval/revision/'.$service['service_general_id']) }}">Revisi</a>
                        <?php }else{ ?>
                            <a type="button" class="btn btn-outline-info btn-sm" href="{{ url('/trans-service-general-approval/detail/'.$service['service_general_id']) }}">Detail</a>
                            <a type="button" class="btn btn-outline-danger btn-sm" href="{{ url('/trans-service-general-approval/revision/'.$service['service_general_id']) }}">Revisi</a>
                        <?php } ?>
