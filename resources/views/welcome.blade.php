        ...
        <div class="masthead">
            ...
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    <img src="{{asset('resources/img/logo/warna.jpg')}}" id="logo" style="width: 450px; height: 350px;">
                    ...
                    <form>
                        ...
                        <div class="row input-group-newsletter">
                            ...
                            <div class="col-auto" href="{{ route('login') }}" ><a href="{{ route('login') }}" class="btn btn-primary" style="margin-top:30px;">Login</a></div>
                        </div>
                    </form>
